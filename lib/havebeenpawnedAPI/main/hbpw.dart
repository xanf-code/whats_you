...
class _HBPState extends State<HBP> {
  ...
  List<Pawned> _pawnedfordisplay = List<Pawned>(); //will serve as filtered down version of notes list
            ...
            children: [
              ...
              Expanded(
                child: ListView.builder(
                    ...
                    itemCount: null == _pawned ? 0 : _pawnedfordisplay.length,
                                    ...
                                    child: SizedBox(
                                      ...
                                      child: RichText(
                                        text: TextSpan(children: [
                                          ...
                                          TextSpan(
                                              text: _pawnedfordisplay[index].title,
                                              style: GoogleFonts.ubuntu(
                                                  color: Colors.white,
                                                  fontSize: 20,
                                                  fontWeight: FontWeight.w500)),
